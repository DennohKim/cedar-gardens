 ...
 <div className="mb-4 border-b border-gray-200 dark:border-gray-700">
    ...
    <div className='sm:grid sm:grid-cols-1 md:grid md:grid-cols-2 md:gap-6 lg:grid lg:grid-cols-2 lg:gap-8'>
        <div className='grid grid-cols-2 gap-4  '>
            ...
            <div className='h-3/4'>
                <img className='h-full w-full'src='https://res.cloudinary.com/dqab6gg7d/image/upload/v1668135337/Cedar%20Hotel/Edited/IMG_2827_hxfhio.jpg' alt='Garden' />
            </div>
        ...
        <div className='h-full -my-36'>
            <img className='h-full w-full' src='https://res.cloudinary.com/dqab6gg7d/image/upload/v1668135075/Cedar%20Hotel/Edited/IMG_7140_vojgco.jpg' alt='garden images' />
        </div>
        <div className='grid grid-cols-2 gap-2 -my-36 '>
          <div className='h-1/2 w-full'>
             <img className='h-full w-full' src='https://res.cloudinary.com/dqab6gg7d/image/upload/v1668135354/Cedar%20Hotel/Edited/IMG_7099_fph3oo.jpg' alt='indiginous trees'/>
          </div>
          <div className='h-1/2 w-full'>
            <img className='h-full w-full' src='https://res.cloudinary.com/dqab6gg7d/image/upload/v1668135357/Cedar%20Hotel/Edited/IMG_7119_rlfhmj.jpg' alt='beautiful terrain'/>
          </div>
          <div className='col-span-2 h-full w-full -my-48 '>
            <img className='h-3/4 w-full ' src='https://res.cloudinary.com/dqab6gg7d/image/upload/v1668135200/Cedar%20Hotel/Edited/IMG_2726_cxcoti.jpg' alt='gardens'/>
          </div>
        </div>
    </div>
