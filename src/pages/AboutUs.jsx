    ...
    <div>
      ...
      <div>
          ...
          <div className="lg:absolute md:absolute sm:relative xs:relative  relative top-[105%] right-[2%] h-[80%] lg:w-[48%] md:w-[50%] sm:w-[100%] w-[100%] bg-white">
            ...
            >
              <Tabs.Group
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="tab-content p-4 lg:ml-[2%] md:ml-[10%] sm:ml-[5%] ml-[10%] font-jost"
                id="tabs-tabContent"
              ...
              >
                <Tabs.Item
                  title="Mission"
                  class="inline-flex p-4  pl-2 uppercase font-jost rounded-t-lg border-b-2 text-black font-bold border-transparent hover:text-green-700 hover:border-green-700 dark:hover:text-green-700 group focus:border-green-700
                  active"
                >
                  <p className="pt-[6%] font-semibold-600 text-black font-jost">
                    To provide our guests with comfortable and exceptional
                    accommodations, personalized service, and a sense of
                    home-away-from-home.
                  </p>{" "}
                </Tabs.Item>
                <Tabs.Item active={true} title="Vision" color="#000000">
                  <p className="pt-[6%] font-semibold-600 text-black font-jost">
                    To be the premier hotel choice for travelers seeking a
                    relaxing and enjoyable experience. We strive to be a leader
                    in the hospitality industry, known for our commitment to
                    excellence and innovation. We aim to continuously improve
                    and enhance the services and amenities we offer, always
                    keeping the needs and satisfaction of our guests at the
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="w-[100%] flex flex-col-reverse justify-center items-center pb-[7%] "
        ...
        >
          <div className="w-[90%] grid lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-2 font-jost">
            ...
            <div className=" h-[230px] bg-[#D4D4D8]/60 p-2 width-[100%] flex-col-reverse inset-0 flex items-center justify-center">
              <p className="pt-[3%] font-semibold-600 text-black text-center">
              Enjoy drinks that make you happy.
              </p>
