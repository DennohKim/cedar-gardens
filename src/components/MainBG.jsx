...
const MainBG = () => {
  return (
    ...
    <motion.div  
      ...
      <h2 className="font-bold text-center text-3xl sm:tracking-[1rem] font-jost text-white font-md md:tracking-[2rem] self-center hover:scale-105 hover:ease-in-out animate-pulse">
        SERVICES
      </h2>
    </motion.div>
  </div>
